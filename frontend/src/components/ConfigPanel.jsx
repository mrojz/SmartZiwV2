                        ...
                        <div className="config-section">
                            ...
                            <div className="config-regions">
                                {Object.entries(regions).map(([name, countries]) => (
                                    <div
                                        key={name}
                                        className={`region-card ${editingRegion === name ? 'expanded' : ''}`}
                                    >
                                        <div
                                            className="region-header"
                                            onClick={() =>
                                                setEditingRegion(editingRegion === name ? null : name)
                                            }
                                        >
                                            <span className="region-name">
                                                {editingRegion === name ? '▾' : '▸'} {name}
                                            </span>
                                            ...
                                            <div className="region-body">
                                                <div className="config-add-row">
                                                    <input
                                                        ...
                                                        onKeyDown={(e) =>
                                                            e.key === 'Enter' && addCountryToRegion(name)
                                                        }
                                                        className="config-input"
                                                    />
                                                    <button
                                                        className="config-add-btn"
                                                        onClick={() => addCountryToRegion(name)}
                                                    >
                                                        +
                                                    </button>
                                                </div>
                                                <div className="config-tags">
                                                    {countries.map((c) => (
                                                        <span key={c} className="config-tag country-tag">
                                                            ...
                                                            <button
                                                                onClick={() =>
                                                                    removeCountryFromRegion(name, c)
                                                                }
                                                            >
                                                                ×
                                                            </button>
